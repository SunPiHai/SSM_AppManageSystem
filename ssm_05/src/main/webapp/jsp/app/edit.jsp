...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <form class="layui-form" action="${pageContext.request.contextPath}/app/edit.do" method="post"><br>
                     <%--修改信息要传id过来--%>
        ...
        <script>
            ...
            layui.use(['element','form','jquery'], function(){
                ...
                //根据查询出的一级分类，自动得到二三级分类start=============================================
                $(function () {
                    //取出一级分类的值
                    var levelOneId = $('#levelOne').val();
                    if(levelOne !='' && levelOne !=null){
                        var levelTwo='${app.categoryLevel2.id }';
                        if (levelOneId !=null && levelTwo !=undefined && levelTwo !=''){
                            $.ajax({
                                url: '/category/queryLevelTwoByLevelOne/' + levelOneId + '.do',
                                type: 'get',
                                success: function (data) {
                ...
                $.ajax({
                    url: '/category/queryLevelThreeByLevelTwo/' + levelTwo + '.do',
                    type: 'get',
                    success: function (data) {
                        var html = '<option value="">-请选择-</option>';
                        var len = data.length;
